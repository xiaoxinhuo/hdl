...
#set_property  -dict {PACKAGE_PIN AF38} [get_ports  rx_ref_clk_1_p]                                           ; ##   GBTCLK2_M2C_P  MGTREFCLK0P_122
#set_property  -dict {PACKAGE_PIN AF39} [get_ports  rx_ref_clk_1_n]                                           ; ##   GBTCLK2_M2C_N  MGTREFCLK0N_122
#
...
#set_property  -dict {PACKAGE_PIN AL35 IOSTANDARD LVDS} [get_ports  glbl_clk_0_p]                             ; ##   LA00_P_CC      IO_L7P_T1L_N0_QBC_AD13P_43
#set_property  -dict {PACKAGE_PIN AL36 IOSTANDARD LVDS} [get_ports  glbl_clk_0_n]                             ; ##   LA00_N_CC      IO_L7N_T1L_N1_QBC_AD13N_43
...
# SYSREF has a half REFCLK period offset from the REFCLK. 
set_input_delay -clock [get_clocks global_clk_0] 1.33 [get_ports rx_sysref_*]
